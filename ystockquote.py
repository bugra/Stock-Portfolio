...
def get_price(symbol):
    '''Get the current price for the given ticker symbol.
...
def get_historical_prices(symbol, start_date, end_date):
    ...
    Example:
      get_historical_prices('GOOG', '20090101','20091231')
      Yields a list of lists of strings for the full year of 2009
